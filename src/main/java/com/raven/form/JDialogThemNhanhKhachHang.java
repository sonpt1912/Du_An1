 ...
 * @author Admin
 */
public class JDialogThemNhanhKhachHang extends javax.swing.JDialog {
    ...
    public JDialogThemNhanhKhachHang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.nhanV = nhanV;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDialogThemNhanhKhachHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDialogThemNhanhKhachHang dialog = new JDialogThemNhanhKhachHang(new javax.swing.JFrame(), true);
