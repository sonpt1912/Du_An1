...
//        }
    ...
    public BigDecimal getDoanhThuDAY() {
        try {
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE DAY(hd.ngayThanhToan) = DAY(sysdatetime()) AND hd.trangThai = 1";
            Query query = SESSION.createQuery(hql);
    ...
    public BigDecimal getDoanhThuMONTH() {
        try {
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = MONTH(sysdatetime()) AND hd.trangThai = 1";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
        } catch (Exception e) {
    ...
    public BigDecimal getDoanhThuYEAR() {
        try {
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE YEAR(hd.ngayThanhToan) = YEAR(sysdatetime()) AND hd.trangThai = 1";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
        } catch (Exception e) {
    ...
    public BigDecimal getDoanhThuThang1() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 1 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang2() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 2 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang3() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 3 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang4() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 4 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang5() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 5 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang6() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 6 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang7() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 7 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang8() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 8 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang9() {
        try {
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 9 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
        } catch (Exception e) {
    ...
    public BigDecimal getDoanhThuThang10() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 10 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang11() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 11 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
    ...
    public BigDecimal getDoanhThuThang12() {
            ...
            String hql = "SELECT SUM(hd.tongTienCanTT) FROM HoaDon hd WHERE MONTH(hd.ngayThanhToan) = 12 AND YEAR(hd.ngayThanhToan) = YEAR(SYSDATETIME())";
            Query query = SESSION.createQuery(hql);
            BigDecimal hoaDons = (BigDecimal) query.getSingleResult();
            return hoaDons;
